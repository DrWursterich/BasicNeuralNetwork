...
public final class ArrayDebug {
	...
	public static void printSizes(double[] a, int s) {
		if (a == null) {
			...
			System.out.print(
					ArrayDebug.printSpaces(s) + String.format("{:%" + ArrayDebug.sizesFormat + "d}", a.length));
		}
	}
	...
	public static void printSizes(double[][] a, int s) {
		if (a == null) {
			...
			System.out.print(
					ArrayDebug.printSpaces(s) +
							String.format(
									"{:%" + ArrayDebug.sizesFormat + "d}[\n" + ArrayDebug.printSpaces(s + 1),
									a.length));
			for (int i = 0; i < a.length; i++) {
	...
	public static void printSizes(double[][][] a, int s) {
		if (a == null) {
			...
			System.out.print(
					ArrayDebug.printSpaces(s) + String.format("{:%" + ArrayDebug.sizesFormat + "}[\n", a.length));
			for (int i = 0; i < a.length; i++) {
	...
	public static void printSizes(double[][][][] a, int s) {
		if (a == null) {
			...
			System.out.print(
					ArrayDebug.printSpaces(s) + String.format("{:%" + ArrayDebug.sizesFormat + "d}[\n", a.length));
			for (int i = 0; i < a.length; i++) {
				ArrayDebug.printSizes(a[i], s + 1);
				System.out.print(i == a.length - 1 ? "\n" + ArrayDebug.printSpaces(s) + "]" : ",\n");
			}
